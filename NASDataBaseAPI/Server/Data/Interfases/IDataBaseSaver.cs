...
/// </summary>
    ...
    {
        Table[] LoadCluster(string path, uint ClusterNumber, string DecodeKey);
        ...
        void SaveAllCluster(DataBaseSettings.DataBaseSettings dataBaseSettings, uint ClusterNumber, Table[] tables);
    }
}
