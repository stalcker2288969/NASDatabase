...
namespace NASAPITests.FasterDataBase.Init
{
    public class CreateAndAddData
    {
        [Fact]
        public void Test_SettingsFile()
        {
            ...
            var DB = DBM.CreateDataBase<NASDataBaseAPI.Server.Data.FasterDataBase>(new DataBaseSettings("BMTest1", "D:\\", SimpleEncryptor.GenerateRandomKey(128)
